...
def banner():
    ...
    print(Colorate.Diagonal(Colors.cyan_to_green, """
     ...
     © B⃨Ả⃨N⃨ Q⃨U⃨Y⃨Ề⃨N⃨ T⃨H⃨U⃨Ô⃨̣C⃨ D⃨O⃨Ã⃨N⃨ S⃨Ơ⃨N⃨
...
def _delay(value):
	while not(value <= 1):
		value -= 0.123
		print(f'''\033[1;39m[\033[1;36mTONY \033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33mX  \033[1;39m ]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTONY \033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTONY \033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}[ \033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTONY \033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
		sleep(0.025)
		print(f'''\033[1;39m[\033[1;36mTONY \033[1;39m][ \033[1;36mDELAY \033[1;39m][\033[1;36m{str(value)[0:5]}\033[1;39m][\033[1;33m    X\033[1;39m]''', '               ', end = '\r')
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}{typee}{do} | {trang}{uuid}{do} | {vang}+1100{do} | {luc}{str(format(int(xu),","))}')
                                    loicamxuc = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
                    ...
                    if like1 == []:
                        ...
                        for x in like2:
                            ...
                            if 'success' in getuid:
                                ...
                                print(f'{red}Link bài viết đã bị die, đang đổi link...', end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                countdown(3)
                            like = CMT(ck, uuid, _info[1], _info[0], ndcmt)
                            if like == False:
                                print(f"{red}FAIL CMT{trang} :{uuid}            ", end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                _Bypass(ck, _info[1], _info[0])
                                loicmt += 1
                                countdown(3)
                            else:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    print(f'{do}| {vang}{dem}{do} | {xanh}{time}{do} | {vang}COMMENT{do} | {trang}{uuid}{do} | {vang}+1400{do} | {luc}{str(format(int(xu),","))}')
                                    loicmt = 0
                                    if dem % doinick == 0:
                                        ptool = 1
                                        break
